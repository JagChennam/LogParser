    ...
    public partial class LogParserForm : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // check if user hit OK button on the dialog
                if (result == DialogResult.OK)
                {
                    ...
                    foreach (string file in files)
                    {
                        ...
                        txtBox.Text += "File Name: " + file.Substring(fileName).Replace("\\", "") + System.Environment.NewLine + "Number of Occurrences: " + times + System.Environment.NewLine;
